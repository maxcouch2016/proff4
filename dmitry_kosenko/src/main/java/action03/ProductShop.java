...
public class ProductShop {
	...
	public static void main(String[] args) {
		...
		/*
		 * Задача 1. Написать программу: Enum TypeProduct{Bread, Yogurt, Milk}
		 * class Product{name, TypeProduct type, int numberParty}
		 * ProductShop{Map<Product, String> shop(Product, NameOfContructor)}
		 * Добавить в Карту по паре продуктов каждого типа. Сделать: 1) Вывести
		 * список фирм в алфавитном порядке 2) Вывести список фирм в обратном
		 * порядке 3) Вывести уникальные наименования товаров с фильтром по типу
		 * продукта
		 */
